...
class _TelaQRCodeState extends State<TelaQRCode> {
  ...
  void didChangeDependencies() {
    ...
    if (args != null) {
      ...
      _qrcodeEsperado = args['qrcodeUrl'] as String?;
    }
  }
  ...
  void _onDetect(BarcodeCapture capture) {
    ...
    final lido = qrCodeData.trim();
    final esperado = _qrcodeEsperado?.trim();

    if (esperado != null && esperado.isNotEmpty && lido == esperado) {
      Navigator.pushReplacementNamed(
        context,
        '/dicas',
        arguments: {
